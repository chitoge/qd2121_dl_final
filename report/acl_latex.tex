...
A critical characteristic observed in the generated samples is the presence of \textit{subtle syntactic deviations}, such as unquoted attributes or omitted references, embedded within otherwise structurally coherent XML. These "imperfect" generations provide empirical support for our loose learning hypothesis above, validating the model's capacity to approximate the grammar flexibly rather than rigidly memorizing the training data.
